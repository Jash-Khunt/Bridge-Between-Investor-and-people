...
const CreateAdvice = () => {
  ...
  const { isCreating, createAdvice } = useAdviceStore();
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (validateForm()) {
      const result = await createAdvice(formData);
      ...
      if (result.success) {
        ...
        setErrors({
          ...
          general:
            result.message ||
            "Failed to create advice article. Please try again.",
        });
      }
    }
  };
    ...
    <div className="container mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Share your expertise and insights with entrepreneurs
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                placeholder="e.g., How to Create a Compelling Pitch Deck"
              />
              {errors.title && (
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Write your advice article here. Share your expertise, insights, and practical tips that will help entrepreneurs succeed..."
            />
            {errors.content && (
          ...
          <div className="rounded-md bg-blue-50 p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>
                • Use clear, actionable language that entrepreneurs can easily
                understand
              </li>
              <li>
                • Include specific examples and real-world scenarios when
                possible
              </li>
              <li>
                • Structure your content with headings and bullet points for
                better readability
              </li>
              <li>
                • Share personal experiences and lessons learned from your
                expertise
              </li>
            </ul>
          </div>
          ...
          <div className="flex justify-end space-x-3 border-t border-gray-200 pt-6">
            ...
            >
              {isCreating ? <LoadingSpinner size="sm" /> : "Publish Article"}
            </button>
          </div>
        </form>
      </div>
